...
public class PlayerAimGun : MonoBehaviour
{
    ...
    private void Start()
    {
        mainCheck = GetComponent<PlayerCode>();
    ...
    public void Shoot(bool press) => shootButton = press;
    ...
    private void Shooting()
    {
        ...
        if ((Input.GetMouseButtonDown(0) || shootButton) && timebet < 0)
        {
            timebet = 0.3f;
            Vector3 mousePosition = GetMouseWorldPosition();
            shootButton = false;
